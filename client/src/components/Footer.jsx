...
function Footer() {
 ...
 <div className='text-center'>
            ...
            <ul className='space-y-2 text-sm'>
                <li onClick={handleSignOut} className='text-red-400 hover:text-red-300 cursor-pointer transition-colors'>SignOut</li>
                <li className='text-gray-300 hover:text-white transition-colors'>
                    <a href="mailto:kumarmanis552@gmail.com">kumarmanis552@gmail.com</a>
                </li>
            </ul>
        </div>
